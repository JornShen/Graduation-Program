...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/datashow/pvaluepricedis.js"></script>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">消费档次-价格分布</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-lg-11">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>消费档次价格分布
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        <div class="chart-container" style="position: relative">
                            <canvas id="pvaluepricedis"></canvas>
                        </div>
                    </div>
                    <!-- /.panel-body -->
                </div>
