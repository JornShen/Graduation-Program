...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/datashow/genderofshop.js"></script>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">购物深度性别统计</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>购物深度性别统计
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        <div class="chart-container" style="position: relative">
                            <canvas id="genderofshop"></canvas>
                        </div>
                    </div>
                    <!-- /.panel-body -->
                </div>
